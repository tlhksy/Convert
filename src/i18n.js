...
en: {
  ...
  'ui.hint.gridUndetermined': 'Coordinates look like a projected grid, but the zone cannot be inferred. Choose the source system.',
  ...
  'log.crs.zoneUndetermined': 'The coordinates are metres on a transverse Mercator grid, but the zone cannot be determined from the values alone: every three-degree zone places its central meridian at the same false easting. The source system must be chosen.',
  ...
  'log.crs.csvUndeclared':   'CSV has no place to record a coordinate reference system. The source system has been assumed and must be confirmed; check also that the column order matches, since latitude-first files are common.',
...
tr: {
  ...
  'ui.hint.gridUndetermined': 'Koordinatlar projekte bir dilime benziyor ama hangi dilim olduğu çıkarılamıyor. Kaynak sistemi seç.',
  ...
  'log.crs.zoneUndetermined': 'Koordinatlar enine Mercator diliminde metre cinsinden, ama hangi dilim olduğu değerlerden çıkarılamıyor: bütün 3° dilimleri merkez meridyeni aynı false easting değerine oturtur. Kaynak sistemi elle seçmek gerekiyor.',
  ...
  'log.crs.csvUndeclared':   'CSV dosyasında koordinat sistemini kaydedecek bir yer yoktur. Kaynak sistem varsayıldı, doğrulanması gerekir; sütun sırasını da kontrol et, enlem-önce dosyalar yaygındır.',
